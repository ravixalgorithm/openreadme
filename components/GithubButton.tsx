    ...
    return (
        <div className="flex justify-center">
            ...
            >
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[92.23%] h-[112.85%] rounded-lg bg-[#010128] filter blur-[7.3px]"></div>
                <div className="relative w-full h-full overflow-hidden rounded-lg">
            ...
            <Github className="flex-shrink-0 w-6 h-6 group-hover:fill-white" />
            Github
          </span>
                </div>
                <button
